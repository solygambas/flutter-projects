...
// make sure you have a currentState
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      _addTrips(); // will run after the build
    });
    // _addTrips();
  }
  ...
  void _addTrips() {
    ...
    //       .insertItem(_tripTiles.length - 1); // to enable animation
    // });
  }
  ...
  Tween<Offset> _offset =
      Tween(begin: Offset(1, 0), end: Offset(0, 0)); // 1 = full width
